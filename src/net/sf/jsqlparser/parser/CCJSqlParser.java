...
public class CCJSqlParser implements CCJSqlParserConstants {
  ...
  private boolean jj_3R_238() {
    if (jj_scan_token(K_DISCONNECT)) return true;
    return false;
  }
